...
export function BookingOverview() {
  const { bookingOverview } = useOps();
  const items = [
    { label: "Today's bookings", value: bookingOverview.todaysBookings, tone: "brand" as const },
    { label: "Upcoming bookings", value: bookingOverview.upcomingBookings, tone: "info" as const },
    { label: "Pending bookings", value: bookingOverview.pendingBookings, tone: "warning" as const },
    { label: "Confirmed bookings", value: bookingOverview.confirmedBookings, tone: "success" as const },
    { label: "Cancelled bookings", value: bookingOverview.cancelledBookings, tone: "danger" as const },
    { label: "Completed stays", value: bookingOverview.completedStays, tone: "muted" as const },
  ];
